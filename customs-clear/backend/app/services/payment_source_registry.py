...
PAYMENT_SOURCE_REGISTRY: tuple[PaymentSourceEntry, ...] = (
    ...
    PaymentSourceEntry(
        ...
        name="Официальный контур акцизных ставок (ЕТТ/НК РФ excerpt)",
        domains=("excise",),
        authority_level="official_binding",
        official_url="https://eec.eaeunion.org/comission/department/catr/ett/",
        legal_basis="ЕТТ ЕАЭС / акцизные ставки при ввозе",
        local_canonical_paths=("data/raw_normative/eec_ett_excise.json",),
        ...
        known_gaps=(
            ...
            "Official excise proof — SourceStatus EEC_EXCISE + excise_source_* row markers.",
            "Без локального eec_ett_excise.json — missing_official_source.",
        ),
    ),
    PaymentSourceEntry(
