...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("7306100000", "Труба для промышленного водоснабжения", "7306", False),
        ("7306100000", "Труба для хозпитьевого водоснабжения промышленного объекта", "7306", True),
        ...
        ("5910000000", "Лента конвейерная промышленная для цеха", "5910", False),
        ("5910000000", "Лента конвейерная техническая для контакта с пищевыми продуктами", "5910", True),
