...
# ═══════════════════════════════════════════════════════════════════
# Graduated from EAEU GSP — больше НЕ пользуются преференциями для
# развивающихся стран (полная ставка РНБ, коэффициент 1.0).
# Решение Совета ЕЭК № 17 от 05.03.2021 — исключение из перечня
# развивающихся стран — пользователей ЕСТП, применяется с 12.10.2021.
# Сейчас зафиксирован достоверный случай — Китай (КНР). Полный аудит
# исключённых стран по Решению № 17 — отдельная задача.
# ═══════════════════════════════════════════════════════════════════
GRADUATED_GSP_COUNTRIES = {
    "CN": "Китай",
}
...
LEGAL_REFS = {
    ...
    "mfn_graduated": "Решение Совета ЕЭК № 17 от 05.03.2021 — исключение из перечня пользователей ЕСТП (с 12.10.2021); применяется базовая ставка РНБ",
...
ALL_GROUPS = [
    ...
    ("gsp", GSP_COUNTRIES),
    ("ldc", LDC_COUNTRIES),
    ("mfn_graduated", GRADUATED_GSP_COUNTRIES),
    ("mfn", MFN_COUNTRIES),
