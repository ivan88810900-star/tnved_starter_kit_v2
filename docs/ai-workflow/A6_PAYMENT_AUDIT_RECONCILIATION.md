...
Date: 2026-09-12. A1 implementation; A5 independent acceptance is required.
...
The red evidence establishes the original defects; it is not a successful acceptance.
The correction commits require fresh focused Actions, existing payment/consumer
regressions, the normal CI gates and independent A5 review. Final run identifiers
are recorded after those checks complete.
