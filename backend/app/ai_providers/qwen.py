"""
Qwen Provider для классификации товаров
"""
import os
import re
import logging
...
class QwenProvider:
    ...
    def classify_with_rag(self, text: str = None, image_b64: str = None, hints: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Ошибка классификации Qwen: {e}")
            return {"error": str(e)}
    ...
    def _classify_with_model(self, features: Dict[str, Any], candidate_codes: List[str], 
        ...
        # Вызов API
        response = self._call_qwen_api(system_prompt, user_message)
    ...
    def _call_qwen_api(self, system_prompt: str, user_message: str) -> str:
        """Вызов Qwen API"""
        headers = {
