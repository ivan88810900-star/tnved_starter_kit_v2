"""
OpenAI Provider для классификации товаров
"""
import os
import re
import logging
...
class OpenAIProvider:
    ...
    def classify_with_rag(self, text: str = None, image_b64: str = None, hints: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Ошибка классификации OpenAI: {e}")
            return {"error": str(e)}
    ...
    def _extract_features(self, text: str, image_b64: str, hints: List[str]) -> Dict[str, Any]:
        ...
        if text:
            ...
            features["keywords"] = words[:20]  # Ограничиваем количество
    ...
    def _narrow_search(self, features: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            keywords = features["keywords"][:5]  # Берем топ-5 ключевых слов
