...
from parsers.tariff_pdf_simple import extract_tariff_data_simple, normalize_hs_code

def test_simple_parser():
    """Тестирует простой парсер"""
    pdf_path = "data/raw/tariff_cet/2025-01-01/ru.14_2022_10.10.2022.pdf"
    
    print(f"📄 Тестирование простого парсера: {os.path.basename(pdf_path)}")
        ...
        with pdfplumber.open(pdf_path) as pdf:
            for page_num, page in enumerate(pdf.pages):
                ...
                if text:
                    ...
                    records = extract_tariff_data_simple(text)
...
def main():
    """Главная функция"""
    print("🚀 Тест простого парсера PDF")
    print("=" * 50)
