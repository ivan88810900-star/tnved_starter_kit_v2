...
| A1 Rates | agent/rates-a6-stage2-20260914 / tariff-a6-stage2-a1 | app/services/payment_engine.py, payment_quote_service.py, scenario_compare_service.py; app/schemas/payment_quote.py; minimal app/api/calculator.py FX propagation; new tests/test_payment_a6_stage2.py and docs/ai-workflow/A6_PAYMENT_STAGE2_RECONCILIATION.md; three obsolete null/geo expectations in test_payment_special_duty_applicability.py and test_payment_preference_eligibility.py |
...
| A4 Consumers | agent/ai-a6-stage2-20260914 / tariff-a6-stage2-a4 | New docs/ai-workflow/PAYMENT_STAGE2_CONSUMER_REVIEW.md; frontend/src/components/payments/SmartPaymentsBlock.tsx partial-sum label and its two existing paymentReview.test.tsx text assertions only; no consumer arithmetic or business-rule changes |
...
- Null as_of is treated consistently as no historical-date request; all
  non-null historical requests, including malformed values,
