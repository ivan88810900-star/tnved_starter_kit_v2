...
PDF. На сохранённом корпусе обработаны 96 PDF / 1 537 страниц / 13 318 упоминаний
кодов; сноски, даты и продолжения строк ещё не интерпретированы. Свежие исходные
файлы из текущей среды получить не удалось; raw-DOM оглавления не проверен.
Ручной CI-запуск загрузки подготовлен, но не выполнялся. Следующий этап — текущий
набор официальных файлов и точная интерпретация строк, сносок и дат, затем
утверждение конкретного снимка и безопасное применение.
...
Новый контур: `docs/ai-workflow/ETT_SOURCE_EVIDENCE.md`.
